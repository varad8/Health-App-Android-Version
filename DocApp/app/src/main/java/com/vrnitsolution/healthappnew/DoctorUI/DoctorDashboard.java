...
import com.vrnitsolution.healthappnew.bookappointment.adapter.AppointmentAdapternew;
...
//        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.navigation_dashboard:
                        if (firebaseUser != null) {
                            ...
                            dcboard.putExtra("email", firebaseUser.getEmail());
                            dcboard.putExtra("doctorId", firebaseUser.getUid());
    ...
    protected void onStart() {
        super.onStart();
        if (firebaseUser != null) {
            getUserData(firebaseUser.getEmail(), firebaseUser.getUid());
            getPatinetActiveAppointments(firebaseUser.getUid());
            getFutureAppointments(firebaseUser.getUid());
    ...
    public void requestLogin() {
        startActivity(new Intent(this, DoctorLogin.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        finish();
    }
