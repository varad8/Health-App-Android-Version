...
//        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void PrescriptionHistory(View view) {
        if (firebaseUser != null) {
            ...
            pres.putExtra("doctorId", firebaseUser.getUid());
            startActivity(pres);
    ...
    protected void onStart() {
        super.onStart();
        if (firebaseUser != null) {
            getDoctorProfile(firebaseUser.getUid(), firebaseUser.getEmail());
        } else {
            redirectToLogin();
        }
    }
    ...
    private void redirectToLogin() {
        startActivity(new Intent(Doctor_Dashboard_Profile.this, DoctorLogin.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        finish();
    }
