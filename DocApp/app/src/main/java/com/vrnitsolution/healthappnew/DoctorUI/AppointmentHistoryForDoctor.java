...
import com.vrnitsolution.healthappnew.bookappointment.adapter.AppointmentAdapter;
...
//        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    private void redirectToLogin() {
        startActivity(new Intent(AppointmentHistoryForDoctor.this, DoctorLogin.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        finish();
    }
