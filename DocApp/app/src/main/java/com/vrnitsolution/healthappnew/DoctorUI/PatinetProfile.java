...
import com.vrnitsolution.healthappnew.DoctorUI.adapter.PatientProfileAdapter;
import com.vrnitsolution.healthappnew.DoctorUI.model.ProfileForMessage;
...
//        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        profileRecyclerView.setLayoutManager(new LinearLayoutManager(PatinetProfile.this,LinearLayoutManager.HORIZONTAL,false));
    ...
    protected void onStart() {
        ...
        getPatientProfiles(user.getUid());
    }
