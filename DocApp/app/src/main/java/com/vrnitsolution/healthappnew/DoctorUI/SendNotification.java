...
//        window.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        backBtnImageview.setOnClickListener(view -> onBackPressed());
...
class ApiClient {
    ...
    private static final String FCM_AUTH_HEADER = "Bearer AAAAKLP2MUE:APA91bEE7H0ahgf-5uqPtYBiI_UFiOgjt7ZpXeQqcc1FionYRH6qJqYgsXrxwv0_35IztCTnijbynYSg3hN85-drDKizjlQwgdUCua9MXAP32oqNGCYc1NnrlezNsGSQkKN93IuyjnrU"; // Replace with your FCM auth token
